...
do  
    ...
    #python giant63_split_cellquant.py -f ${dirname}/${filename}.lsm 
    ...
    #do python giant63_count_distances.py -f ${i} ;
    #do python giant63_distmap.py -f $i &
    #do python giant63_mask_maker.py --upscale -f $i &
    #python giant63_mask_maker.py --upscale -f ${basedir}/${batch}/${filename}/${filename}_cr_reduced20_biofilmmask.mat 
    #do python giant63_mask_maker.py --downscale --lsm_guess $i;
