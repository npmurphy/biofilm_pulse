...
base = '/home/nmurphy/SLCU/teamJL/Niall/bfpulse_paper_data/datasets/padmovies_brightfield/hists/';
...
multischnitz_to_histo_tsv(delRU_list, [base 'delru.tsv'], [base 'delru_schnitzamp.txt']);
multischnitz_to_histo_tsv(sigB_list, [base 'wt.tsv'], [base 'wt_schnitzamp.txt']);
multischnitz_to_histo_tsv(delQP_list, [base 'delqp.tsv'], [base 'delqp_schnitzamp.txt']);

% export_multischnitz(p_delQP, [base 'delqp.tsv']);
% export_multischnitz(p_sigB, [base 'sigb.tsv']);
