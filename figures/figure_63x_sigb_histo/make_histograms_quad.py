...
FP_max_min = [(0, 30000), (1000, 11000)]  # RFP  # YFP
...
def main():
    ...
    axes = subfig_normalised_histos.get_figure(
    ...
    fig.subplots_adjust(
        left=0.05, right=0.95, top=0.99, bottom=0.1, hspace=0.08, wspace=0.20
    )
    width, height = figure_util.get_figsize(
        figure_util.fig_width_small_pt, wf=1.0, hf=0.9
    )
