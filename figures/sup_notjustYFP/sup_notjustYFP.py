...
tilescan = os.path.join(this_dir, "../../proc_data/frozen_sigw/sigw_48hrs_center_3.tiff")
...
length = 100 
outim = lib.figure_util.draw_scale_bar(outim, 20, outim.shape[1]-200 ,
                               scale_length=length/PX_TO_UM,
                               thickness=30,
                               legend = "{0}μm".format(length), fontsize=40)
